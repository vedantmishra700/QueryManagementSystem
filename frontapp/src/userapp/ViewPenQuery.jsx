   ...
   <div className="row vh-7">
    ...
    <div className="row vh-93 ">
     ...
     <div className="col-10 h-100 scroll bg-secondary">
       ...
       <div className="col-md-6 table-responsive mx-auto my-auto p-2 rounded-3 shadow-lg bg-light border border-5 border-danger">
            ...
            <tbody>
                {penquery?.map((e) => (
                    ...
                    <tr>
                        ...
                        <td>{e.subject}</td>
                        <td>{e.description}</td>
                        <td> <Link to={`/editPenQuery/${id}`} className='btn btn-primary'>Edit</Link></td>
                    </tr>
                ))}
            </tbody>
        </table>
